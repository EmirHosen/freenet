  ...
  $.getJSON('posts.json', function (data) {
    ...
    $.each(posts, function (i, a) {
      ...
      let blog_post = '<div class=\'blog__item card\'>' +
        ...
        '<p class=\'blog__item-social\'><i class=\'mdi mdi-eye\'></i> ' + a.views + ' <span>بینندگان</span></p>' +
        '<a class=\'blog__item-social link link--accent\' href=\'' + a.link + '#comments\'><i class=\'mdi mdi-comment\'></i> ' + a.comments + ' <span>نظرات</span></a>' +
        '<a class=\'blog__item-social blog__item-social--like link link--accent' + like + '\' data-post-id=\'' + a.id +
        '\'><i class=\'mdi mdi-heart\'></i> ' + likes + ' <span>نفر پسندیدند</span></a>' +
        '</div>' +
        '</div>' +
        '</div>';
    ...
    if (page === '1') {
      ...
      let blog_post = '<div class=\'blog__item-img-wrap\'>' +
        ...
        '<hr/>' +
        '<div class=\'blog__item-content-bottom\'>' +
        '<p class=\'blog__item-social\'><i class=\'mdi mdi-eye\'></i> ' + first.views + ' <span>بینندگان</span></p>' +
        '<a class=\'blog__item-social link link--accent\' href=\'' + first.link + '#comments\'><i class=\'mdi mdi-comment\'></i> ' + first.comments + ' <span>نظرات</span></a>' +
        '<a class=\'blog__item-social blog__item-social--like link link--accent' + like + '\' data-post-id=\'' + first.id +
        '\'><i class=\'mdi mdi-heart\'></i> ' + likes + ' <span>نفر پسندیدند</span></a>' +
        '</div>' +
        '<a href=\'' + first.link + '\' class=\'site-btn site-btn--light blog__item-btn\'>به خواندن ادامه دهید</a>' +
        '</div>';
