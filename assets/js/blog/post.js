...
$('.post__comment-reply').on('click', function () {
  ...
  let post_form = '<div class=\'post__write-comment form form--comment\'>' +
    '<h4>ارسال یک نظر</h4>' +
    '<button class=\'post__write-comment-cancel link link--accent\'>لغو ارسال</button>' +
    '<form class=\'form__form\'>' +
    '<div class=\'form__group\'>' +
    '<div class=\'form__form-group\'>' +
    '<label class=\'form__label\'>نام</label>' +
    '<input class=\'form__input js-field__name\' type=\'text\' placeholder=\'نام خود را بنویسید\'>' +
    '<span class=\'form-validation\'></span>' +
    '</div>' +
    '<div class=\'form__form-group\'>' +
    '<label class=\'form__label\'>ایمیل <span>*</span></label>' +
    '<input class=\'form__input js-field__name\' type=\'email\' placeholder=\'example@gmail.com\' required>' +
    '<span class=\'form-validation\'></span>' +
    '</div>' +
    '<div class=\'form__form-group\'>' +
    '<label class=\'form__label\'>وبسایت</label>' +
    '<input class=\'form__input js-field__url\' type=\'url\' placeholder=\'آدرس وبسایت\'>' +
    '<span class=\'form-validation\'></span>' +
    '</div>' +
    '</div>' +
    '<div class=\'form__form-group\'>' +
    '<label class=\'form__label\'>متن نظر <span>*</span></label>' +
    '<textarea class=\'form__input form__input--textarea js-field__message\' type=\'url\' required' +
    '          placeholder=\'متن مدنظر خود را بنویسید\'></textarea>' +
    '<span class=\'form-validation\'></span>' +
    '</div>' +
    ...
    '<span class=\'checkbox-btn__label\'>نظرات جدید را از طریق ایمیل به من اطلاع دهید.</span>' +
    '</label>' +
    '</div>' +
    '<button class=\'site-btn site-btn--accent form__submit\' type=\'submit\' value=\'Send\'>ارسال نظر</button>' +
    '</form>' +
    '</div>';
...
$('.js-field__category').attr('placeholder', 'انتخاب دسته بندی');
$('.js-field__month').attr('placeholder', 'انتخاب ماه');
...
$(function () {
  ...
  for (let i = 0; i < post.length; i++) {
    ...
    if (localStorage.getItem(post_id)) {
      ...
      let start ='<i class=\'mdi mdi-heart\'></i> ';
      let end = ' <span>نفر پسندیدند</span>';
